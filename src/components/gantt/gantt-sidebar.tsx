  ...
  return (
    <div className="shrink-0 border-r bg-background flex flex-col" style={{ width: 360 }}>
      ...
      >
        ...
        <div className="w-24 px-2 py-2 text-center border-r">Start</div>
        <div className="w-24 px-2 py-2 text-center">End</div>
      </div>
      ...
      {tasks.map((task, index) => (
        ...
        >
          <div className="flex-1 flex items-center gap-2 px-3 min-w-0 border-r">
            {hasProject(task) && (
              <div
          ...
          <div className="w-24 px-2 text-xs text-muted-foreground text-center border-r">
            {task.start_date ? format(new Date(task.start_date + "T00:00:00"), "MMM d") : "-"}
          </div>
          <div className="w-24 px-2 text-xs text-muted-foreground text-center">
